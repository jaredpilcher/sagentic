...
import { 
    ...
    AlertCircle, RefreshCw, Search, Filter, BarChart3
} from 'lucide-react'
    ...
    return (
        <div className="space-y-6">
            <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 className="text-2xl md:text-3xl font-bold tracking-tight">All Runs</h2>
                    <p className="text-muted-foreground text-sm md:text-base mt-1">
                        Browse and filter your workflow execution history.
                    </p>
                </div>
